    ...
    <Layout>
      <div className="bg-emerald-50 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Content on the Studyassistants website may be protected by U.S. and
          ...
          <p className="mb-4">
            ...
            Studyassistants strives for accuracy but cannot guarantee the
            reliability of third-party information. Studyassistants is not
            responsible for actions taken based on this information or for any
            resulting consequences.
          </p>
          <p className="mb-4">External Links</p>
          <p className="mb-4">
            Studyassistants’s website may include links to external sites
            ...
            imply endorsement by Studyassistants. Links may be removed or
            updated at any time without notice.
          </p>

          <p className="mb-4">
            For concerns about linked external sites, please contact the
            respective organizations. Studyassistants is not responsible for the
