    ...
    <Layout>
      ...
      <div className="">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <p className="mb-4">
            Enjoy the ease of expert-led consultation or training, customized to
            your schedule and preferred location.
          </p>

          <p className="mb-4">
            Share your needs, and we’ll design a solution that addresses
            concerns and maximizes benefits for you and your team.
          </p>

          <h2 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">
            Our personalized consulting/training services include:
          </h2>
          <ul className="max-w-md space-y-1 list-disc list-inside dark:text-gray-400">
            ...
            <li> Expert access.</li>
            <li> Scalable solutions for all group sizes.</li>
          </ul>
        </div>
      </div>
